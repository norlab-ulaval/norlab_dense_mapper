...
norlab_dense_mapper::DenseMapper::DenseMapper(const std::string& inputFiltersConfigFilePath, const std::string& icpConfigFilePath,
...
void norlab_dense_mapper::DenseMapper::loadYamlConfig(const std::string& inputFiltersConfigFilePath, const std::string& icpConfigFilePath,
...
void norlab_dense_mapper::DenseMapper::processInput(const PM::DataPoints& inputInSensorFrame, const PM::TransformationParameters& estimatedPose,
...
bool norlab_dense_mapper::DenseMapper::shouldUpdateMap(const std::chrono::time_point<std::chrono::steady_clock>& currentTime,
...
void norlab_dense_mapper::DenseMapper::updateMap(const PM::DataPoints& currentInput, const PM::TransformationParameters& currentPose,
										  const std::chrono::time_point<std::chrono::steady_clock>& currentTimeStamp)
{
	...
	{
		mapUpdateFuture = std::async(std::launch::async, &DenseMap::updateLocalPointCloud, &map, currentInput, currentPose, mapPostFilters);
	}
	else
	{
...
norlab_dense_mapper::DenseMapper::PM::TransformationParameters norlab_dense_mapper::DenseMapper::getPose()
{
